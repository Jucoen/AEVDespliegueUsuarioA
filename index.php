...
$palabras = ['elefante', 'jirafa', 'hipopotamo', 'rinoceronte', 'cocodrilo', 'camello', 'chimpance', 'pirata', 'ahorcado', 'gato', 'perro', 'pelicula', "videojuego", 'micrófono', 'ordenador', 'taza', 'alfombrilla', 'figura', 'caja'];
...
if ($_SESSION['letras_acertadas'] == $_SESSION['palabra']) {
    session_destroy();
    header('Location: victoria.html');
    exit();
} elseif ($_SESSION['vidas'] <= 0) {
    session_destroy();
    header('Location: derrota.html');
    exit();
}
?>
